...
let signdta = JSON.parse(localStorage.getItem("userdata")) || [];
let Sdata = localStorage.getItem("user");
...
function login(event) {
  ...
  let serch = Sdata.filter(function (elem) {
    return email == elem.email;
  });
  if (serch.length == 0 && email != "" && password != "") {
    p1.innerText =
      "Sorry, looks like something went wrong. Please correct the following and submit again:";
  ...
  if (serch.length > 0) {
    ...
    if (flag == true) {
      ...
      localStorage.setItem("userkey", "Gauti");
      ...
      p1.style.fontFamily = "poppins Sans,sans serif";
      let r = document.querySelector("#gautam>#mess");
      r.append(p1, p2);
      form.reset();
    }
  }
...
>>>>>>> 72dfe51fdf0b32f26a1e6ee5cd21116d55ad880e
